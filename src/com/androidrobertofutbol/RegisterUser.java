...
public class RegisterUser extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(isLoggedIn)
		{
			...
			EditText nameField = (EditText) this.findViewById(R.id.nombreRegistro);
			nameField.setText(name);
			
			EditText emailField = (EditText) this.findViewById(R.id.gmailRegistro);
			emailField.setText(email);
			
			EditText passwordField = (EditText) this.findViewById(R.id.contraRegistro);
			passwordField.setText(password);
			
			EditText passwordConfirmationField = (EditText) this.findViewById(R.id.confirmacionRegistro);
			passwordConfirmationField.setText(password);
			
			Button submitButton = (Button) this.findViewById(R.id.registroBoton);
	...
	public void registrarsebutton(View view) {
		...
		EditText passField = (EditText) this.findViewById(R.id.contraRegistro);
		String pass = passField.getText().toString();
		
		EditText confirmPassField = (EditText) this.findViewById(R.id.confirmacionRegistro);
